...
|---|---|--------|---|---|---|----|---|---|---|---|---|---|---|
|Farama Foundation||||||||||||
|[Gymnasium](https://gymnasium.farama.org/)|<img src="https://github.com/user-attachments/assets/5e305d37-f3ef-423d-805d-2557bf0ad785" width=50 height= 50>|Originally 'OpenAI Gym' <br> The first port of call. Contains many styles of environment from toy envs, classic control to Atari |✅|❌|From scratch (good documentation)|✅|Many|Simple-medium|✅|✅|✅|✅|✅|
|---|---|---|---|---|---|----|---|---|---|---|---|---|---|
|---|---|---|---|---|---|----|---|---|---|---|---|---|---|
