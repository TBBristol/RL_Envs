...
|[Mujoco](https://mujoco.org/)|<img src="https://github.com/user-attachments/assets/b1f33e16-8665-40f6-b05b-9f753db3c83a" width=50 height=50>|Multi-Joint Dynamics with Contact. Suited to simulating robotic and biomechanics, examples inc. in OpenAI gym.Mostly stochastic(not deterministic in initial state).|Continuous|Potential|Fully but complex (written in C)|----|---|---|---|---|---|---|---|
...
|[Starcrft 2](https://github.com/google-deepmind/pysc2)|<img src="https://github.com/user-attachments/assets/3f1827f7-fa70-4c7f-86c8-601eecf1278f" wiodth=50 height=50>|An RL environement based on the game Starcraft2. A difficult RL problem used. Some "mini" games with potential for simpler senarios|---|---|---|----|---|---|---|---|---|---|---|
